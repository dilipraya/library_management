    ...
    public class LibraryInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<LibraryContext>
    {
        protected override void Seed(LibraryContext context)
        {
            ...
            var members = new List<Member>
            {
                ...
                new Member { first_name = "Ada", last_name = "Lovelace", gender = "female", date_of_birth = DateTime.Parse("1965-12-10"), email = "love@example.com", contact_number = "9851056894", address = "Tennessace, Oklahoma", MembershipTypeID = 3},
            };
            ...
            var bookCopy1 = new BookCopy { bookCopyNo = 1, rackID = 1 };
            var bookCopy2 = new BookCopy { bookCopyNo = 2, rackID = 2 };
            var bookCopy3 = new BookCopy { bookCopyNo = 3, rackID = 3 };
            var bookCopy4 = new BookCopy { bookCopyNo = 4, rackID = 4 };
            var bookCopy5 = new BookCopy { bookCopyNo = 1, rackID = 1 };
            var bookCopy6 = new BookCopy { bookCopyNo = 2, rackID = 2 };
            var bookCopy7 = new BookCopy { bookCopyNo = 3, rackID = 5 };
            var bookCopy8 = new BookCopy { bookCopyNo = 4, rackID = 6 };
            var bookCopy9 = new BookCopy { bookCopyNo = 1, rackID = 5 };
            var bookCopy10 = new BookCopy { bookCopyNo = 2, rackID = 6 };
            var bookCopy11 = new BookCopy { bookCopyNo = 3, rackID = 7 };
            var bookCopy12 = new BookCopy { bookCopyNo = 4, rackID = 8 };
            var bookCopy13 = new BookCopy { bookCopyNo = 5, rackID = 10 };
            var bookCopy14 = new BookCopy { bookCopyNo = 6, rackID = 11 };
            var bookCopy15 = new BookCopy { bookCopyNo = 1, rackID = 11 };
            var bookCopy16 = new BookCopy { bookCopyNo = 2, rackID = 8 };
            var bookCopy17 = new BookCopy { bookCopyNo = 3, rackID = 12 };
            var bookCopy18 = new BookCopy { bookCopyNo = 1, rackID = 7 };
            var bookCopy19 = new BookCopy { bookCopyNo = 2, rackID = 12 };
            var bookCopy20 = new BookCopy { bookCopyNo = 1, rackID = 5 };
